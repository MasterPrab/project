                            ...
                            <div key={shop._id} className="shop-item border p-4 my-4 rounded bg-white shadow-md">
                                <div className="shop-details mb-4">
                                    ...
                                    <form action={updateShop} className="mb-2">
                                        ...
                                        <div><input type="hidden" name="id" value={shop._id} /></div>
                                        <div><input type="text" name="name" defaultValue={shop.name} required className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="number" name="priceLevel" defaultValue={shop.priceLevel} required min={1} max={4} className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="text" name="picture" defaultValue={shop.picture} required className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="text" name="address" defaultValue={shop.address} required className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="text" name="province" defaultValue={shop.province} required className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="number" name="postalcode" defaultValue={shop.postalcode} required min={10000} max={99999} className="border p-2 mb-2 w-full" /></div>
                                        <div><input type="text" name="tel" defaultValue={shop.tel} required className="border p-2 mb-2 w-full" /></div>
                                        <div><button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white p-2 w-full">Update</button></div>
                                        
                                    </form>
                                    
                                    <form action={deleteShop}>
                                        <input type="hidden" name="id" value={shop._id} />
                                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white p-2 w-full">Delete</button>
                                    </form>
                                </div>
                            </div>
                        ))}
